...
var cssBundleHref = "/build/css-bundle-7WQQKWE6.css";
...
var Check = () => /* @__PURE__ */ jsxDEV3("svg", { stroke: "currentColor", fill: "currentColor", strokeWidth: "0", viewBox: "0 0 24 24", height: "1em", width: "1em", xmlns: "http://www.w3.org/2000/svg", children: [
  ...
  lineNumber: 4,
  columnNumber: 5
}, this), check_svg_default = Check;

// app/icons/edit.svg.tsx
import { jsxDEV as jsxDEV4 } from "react/jsx-dev-runtime";
var Edit = () => /* @__PURE__ */ jsxDEV4("svg", { stroke: "currentColor", fill: "currentColor", "stroke-width": "0", viewBox: "0 0 24 24", height: "1em", width: "1em", xmlns: "http://www.w3.org/2000/svg", children: [
  ...
  lineNumber: 4,
  columnNumber: 5
}, this), edit_svg_default = Edit;

// app/icons/delete.svg.tsx
import { jsxDEV as jsxDEV5 } from "react/jsx-dev-runtime";
var Delete = () => /* @__PURE__ */ jsxDEV5("svg", { stroke: "currentColor", fill: "currentColor", "stroke-width": "0", viewBox: "0 0 24 24", height: "1em", width: "1em", xmlns: "http://www.w3.org/2000/svg", children: [
  ...
  lineNumber: 4,
  columnNumber: 5
}, this), delete_svg_default = Delete;

// app/icons/unchecked.svg.tsx
import { jsxDEV as jsxDEV6 } from "react/jsx-dev-runtime";
var Unchecked = () => /* @__PURE__ */ jsxDEV6("svg", { stroke: "currentColor", fill: "currentColor", "stroke-width": "0", viewBox: "0 0 24 24", height: "1em", width: "1em", xmlns: "http://www.w3.org/2000/svg", children: [
  ...
  lineNumber: 4,
  columnNumber: 5
}, this), unchecked_svg_default = Unchecked;
...
var useHandleTemplateSubmit = ({
  onTemplateSubmit,
  initialInputs
}) => React2.useCallback((event) => {
  let $target = event.target;
  if (!($target instanceof HTMLFormElement))
    return;
  event.preventDefault(), event.stopPropagation();
  let formData = new FormData($target), formObject = Object.fromEntries(formData), notes = Object.keys(formObject).filter((key) => key.startsWith("note-")).map((key) => formObject[key]);
  onTemplateSubmit({
    ...initialInputs,
...
}, [onTemplateSubmit, initialInputs]), useHandleTemplateSubmit_default = useHandleTemplateSubmit;
...
var TodoTemplate = ({
  ...
  let [notesLength, setNotesLength] = React3.useState((initialInputs == null ? void 0 : initialInputs.notes.length) || 0), handleTemplateSubmit = useHandleTemplateSubmit_default({ onTemplateSubmit, initialInputs });
  return /* @__PURE__ */ jsxDEV8(
    "form",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxDEV8("input", { id: "title", name: "title", type: "text", required: !0, placeholder: "My task", defaultValue: initialInputs == null ? void 0 : initialInputs.title }, void 0, !1, {
          fileName: "app/components/TodoTemplate/index.tsx",
          lineNumber: 28,
          columnNumber: 13
        }, this),
        ...
        /* @__PURE__ */ jsxDEV8("textarea", { id: "description", name: "description", required: !0, placeholder: "> My description (you can use markdown here)", defaultValue: initialInputs == null ? void 0 : initialInputs.description }, void 0, !1, {
          fileName: "app/components/TodoTemplate/index.tsx",
          lineNumber: 30,
          columnNumber: 13
        }, this),
        ...
        /* @__PURE__ */ jsxDEV8("input", { id: "deadline", name: "deadline", type: "date", required: !0, defaultValue: initialInputs == null ? void 0 : initialInputs.deadline.toISOString().split("T")[0] }, void 0, !1, {
          fileName: "app/components/TodoTemplate/index.tsx",
          lineNumber: 32,
          columnNumber: 13
        }, this),
        /* @__PURE__ */ jsxDEV8("div", { role: "radiogroup", "aria-labelledby": "priority", children: [
          ...
          Object.entries(priority_default).filter(([priorityName]) => Number.isNaN(Number(priorityName))).map(
            ([priorityName, priority2]) => /* @__PURE__ */ jsxDEV8("label", { htmlFor: priorityName, children: [
              /* @__PURE__ */ jsxDEV8("input", { id: priorityName, name: "priority", type: "radio", required: !0, defaultChecked: (initialInputs == null ? void 0 : initialInputs.priority) === priority2, value: priorityName }, void 0, !1, {
                fileName: "app/components/TodoTemplate/index.tsx",
                lineNumber: 40,
                columnNumber: 29
              }, this),
        ...
        Array.from(
          ...
          (_, i) => {
            ...
            return /* @__PURE__ */ jsxDEV8(React3.Fragment, { children: [
              ...
              /* @__PURE__ */ jsxDEV8("input", { id: `note-${i}`, name: `note-${i}`, required: !0, defaultValue: (_a = initialInputs == null ? void 0 : initialInputs.notes) == null ? void 0 : _a[i] }, void 0, !1, {
                fileName: "app/components/TodoTemplate/index.tsx",
                lineNumber: 49,
                columnNumber: 21
              }, this),
              i === notesLength - 1 && /* @__PURE__ */ jsxDEV8("button", { type: "button", onClick: () => setNotesLength(notesLength - 1), children: [
                "Remove note ",
                i + 1
              ] }, void 0, !0, {
                fileName: "app/components/TodoTemplate/index.tsx",
        ...
        /* @__PURE__ */ jsxDEV8("button", { type: "button", onClick: () => setNotesLength(notesLength + 1), children: "Add note" }, void 0, !1, {
          fileName: "app/components/TodoTemplate/index.tsx",
          lineNumber: 55,
          columnNumber: 13
        }, this),
...
var useHandleTodoSubmit = ({
  todoItems,
  setTodoItems
}) => React4.useCallback((entry2, postSubmission = !0) => {
  let todoItem = {
    ...entry2,
    notes: entry2.notes || [],
    onEdit() {
...
}, [todoItems, setTodoItems]), useHandleTodoSubmit_default = useHandleTodoSubmit;
...
var useHandleTodoUpdate = ({
  ...
  editIndex,
  setEditIndex
}) => React5.useCallback((entry2) => {
  setTodoItems([...todoItems.slice(0, editIndex), entry2, ...todoItems.slice(editIndex + 1)]), setEditIndex(-1), fetch("/api/todos", {
    method: "PUT",
    headers: new Headers({
      "content-type": "application/json"
    }),
...
}, [todoItems, setTodoItems, editIndex, setEditIndex]), useHandleTodoUpdate_default = useHandleTodoUpdate;
...
}, [todoItems, setTodoItems]), useHandleTodoDelete_default = useHandleTodoDelete;
...
function useHandleTodoSetStatus({
  ...
  return React9.useCallback((status2, i) => {
...
var Todo = () => {
  let [editIndex, setEditIndex] = React10.useState(-1), [todoItems, setTodoItems] = React10.useState([]), handleTodoSubmit = useHandleTodoSubmit_default({ todoItems, setTodoItems }), handleTodoUpdate = useHandleTodoUpdate_default({ todoItems, setTodoItems, editIndex, setEditIndex }), handleTodoSetStatus = useHandleTodoSetStatus_default({ todoItems, setTodoItems }), handleTodoDelete = useHandleTodoDelete_default({ todoItems, setTodoItems }), sortedTodoItems = useSortedTodoItems_default(todoItems);
...
var assets_manifest_default = { entry: { module: "/build/entry.client-5EMYRQVM.js", imports: ["/build/_shared/chunk-JXHNNPNR.js", "/build/_shared/chunk-H36SQQE5.js", "/build/_shared/chunk-JKUASME7.js", "/build/_shared/chunk-ZOMPIGGR.js", "/build/_shared/chunk-ZNB6WRFP.js", "/build/_shared/chunk-N4FG5RPV.js", "/build/_shared/chunk-TVZC3ZTX.js", "/build/_shared/chunk-RODUX5XG.js"] }, routes: { root: { id: "root", parentId: void 0, path: "", index: void 0, caseSensitive: void 0, module: "/build/root-QA7QNOOG.js", imports: void 0, hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/_index": { id: "routes/_index", parentId: "root", path: void 0, index: !0, caseSensitive: void 0, module: "/build/routes/_index-462PR3HQ.js", imports: void 0, hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 } }, version: "4f30d342", hmr: { runtime: "/build/_shared\\chunk-ZNB6WRFP.js", timestamp: 1694165596410 }, url: "/build/manifest-4F30D342.js" };
